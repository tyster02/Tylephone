 ...
 * - 1 Passive buzzer on GPIO25 (DAC1), connected through a LM358, in a non-inverting amplifier using 2 100k resistors.
...
DISCLAIMER: THIS WAS VIBE-CODED, BUT IT'S PRETTTY COOL, SO PLEASE DON'T GET MAD, YOU CAN MAKE ONE YOURSELF FROM THE GITHUB JUST MAYBE BUY ME A COFFEE? https://buymeacoffee.com/tylerjohnsonengineering
...
void IRAM_ATTR onTimer() {
  ...
  if (phaseIncrement == 0 || !ratchetOn) { //If no note is playing, or if we're in the silent part of the ratchet, don't plan anything
...
void updateDisplay() {
  ...
  switch (currentMode) {
    case REST:
        ...
        volumeLevel = (encoderValue * 8) / 100;
